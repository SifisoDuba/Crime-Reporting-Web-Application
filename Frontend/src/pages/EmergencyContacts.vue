<template>
  <div class="container">
    ...
    <div class="contacts-section">
      <div v-if="filteredCategories.length" v-for="category in filteredCategories" :key="category.id">
...
.emergency { background: linear-gradient(135deg, #ef4444, #b91c1c); }
.police { background: linear-gradient(135deg, #2563eb, #1d4ed8); }
.medical { background: linear-gradient(135deg, #10b981, #059669); }
